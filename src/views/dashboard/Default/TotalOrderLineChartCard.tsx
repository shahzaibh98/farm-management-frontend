                ...
                <Grid container justifyContent="space-between">
                  ...
                  <Grid item>
                    <Button
                      ...
                      size="small"
                      sx={{ color: 'inherit' }}
                      onClick={(e: any) => handleChangeTime(e, true)}
                    >
                      Month
                    </Button>
                    <Button
                      ...
                      size="small"
                      sx={{ color: 'inherit' }}
                      onClick={(e: any) => handleChangeTime(e, false)}
                    >
                      Year
                    </Button>
                  </Grid>
              ...
              <Grid item sx={{ mb: 0.75 }}>
                <Grid container alignItems="center">
                  ...
                  <Grid item xs={6}>
                    {timeValue ? (
                      <Chart
                        {...(ChartDataMonth as unknown as ReactApexChart)}
                      />
                    ) : (
                      <Chart
                        {...(ChartDataYear as unknown as ReactApexChart)}
                      />
                    )}
                  </Grid>
                </Grid>
